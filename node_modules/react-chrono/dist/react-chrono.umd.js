...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('nanoid'), require('react'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'nanoid', 'react', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactCrono = {}, global.nanoid, global.React, global.ReactDOM));
}(this, (function (exports, nanoid, React, ReactDOM) { 'use strict';
  ...
  useNewScrollPosition = function (mode, itemWidth) {
    var ref = React.useState(0);
    var newOffset = ref[0];
    var setNewOffset = ref[1];
    var computeNewOffset = React.useCallback(function (parent, scroll) {
  ...
  var useNewScrollPosition$1 = useNewScrollPosition;

  var ChevronLeft = function () { return React__default['default'].createElement("svg", {
  ...
  var ChevronRightIcon = function () { return React__default['default'].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
  ...
  var ChevronLeft$1 = function () { return React__default['default'].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
  ...
  var ChevronRightIcon$1 = function () { return React__default['default'].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
  ...
  var ReplayIcon = function () { return React__default['default'].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
...
`;
  ...
  var TimelineControl = React__default['default'].memo(function (ref) {
    ...
    return React__default['default'].createElement(TimelineControlContainer, {
      slideShowActive: slideShowRunning
    }, React__default['default'].createElement(TimelineNavWrapper, {
      className: "timeline-controls"
    }, React__default['default'].createElement(TimelineNavItem, {
      disable: disableLeft
    }, React__default['default'].createElement(TimelineNavButton, {
      mode: mode,
      theme: theme,
      onClick: onFirst,
      title: "Go to First",
      "aria-label": "first"
    }, React__default['default'].createElement(ChevronLeft$1, null))), React__default['default'].createElement(TimelineNavItem, {
      disable: disableLeft
    }, React__default['default'].createElement(TimelineNavButton, {
      mode: mode,
      theme: theme,
      ...
      title: "Previous",
      "aria-label": "previous"
    }, React__default['default'].createElement(ChevronLeft, null))), React__default['default'].createElement(TimelineNavItem, {
      ...
      title: "Next",
      "aria-label": "next"
    }, React__default['default'].createElement(ChevronRightIcon, null))), React__default['default'].createElement(TimelineNavItem, {
      disable: disableRight
    }, React__default['default'].createElement(TimelineNavButton, {
      mode: mode,
      theme: theme,
      ...
      title: "Go to Last",
      "aria-label": "last"
    }, React__default['default'].createElement(ChevronRightIcon$1, null))), React__default['default'].createElement(TimelineNavItem, null, slideShowEnabled && React__default['default'].createElement(ReplayWrapper, {
      theme: theme,
      onClick: onReplay,
      title: "Play Slideshow"
    }, React__default['default'].createElement(ReplayIcon, null)))));
  });
  ...
  line-height: 1.5rem;
  margin: ${function (p) { return p.mode !== 'VERTICAL_ALTERNATING' ? '1rem 0' : ''; }};
  position: relative;
  text-align: left;
  width: 100%;
...
`;
  ...
  overflow-x: hidden;
  overflow-y: auto;
  scrollbar-color: ${function (p) { return p.theme.primary; }} default;
...
`;
  ...
  var slideAnimation = function (start, end) { return keyframes`
  0% {
    width: ${start}px;
  }
  100% {
...
`;
  var ChevronIconWrapper = newStyled.span`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 1rem;
...
`;
  ...
  var MemoTitle = React__default['default'].memo(function (ref) {
    var title = ref.title;
    var theme = ref.theme;
    var color = ref.color;
    var dir = ref.dir;
    ...
    return title && theme ? React__default['default'].createElement(TimelineContentTitle, {
  ...
  var MemoContentText = React__default['default'].memo(function (ref) {
    var content = ref.content;
    var color = ref.color;
    var dir = ref.dir;

    return content ? React__default['default'].createElement(TimelineContentText, {
    style: {
      color: color
    },
    dir: dir,
  ...
  text-align: center;
  ${function (p) { return p.cardHeight ? `min-height: ${p.cardHeight}px;` : ''; }}
...
`;
  ...
  var CardMedia = function (ref) {
    ...
    var hideMedia = ref.hideMedia; if ( hideMedia === void 0 ) hideMedia = false;
    ...
    var handleMediaLoaded = React.useCallback(function () {
      setMediaLoaded(true);
    }, []);
    ...
    var ErrorMessageMem = React__default['default'].memo(function (ref) {
      var message = ref.message;

      return React__default['default'].createElement(ErrorMessage, null, message);
    });
    ErrorMessageMem.displayName = 'Error Message';
    return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement(MediaWrapper, {
      theme: theme,
      active: active,
      mode: mode,
    ...
    }, media.type === 'VIDEO' && (!loadFailed ? React__default['default'].createElement(CardVideo, {
      controls: true,
      autoPlay: active,
      ref: videoRef,
    ...
    })) : React__default['default'].createElement(ErrorMessageMem, {
      message: "Failed to load the video"
    })), media.type === 'IMAGE' && (!loadFailed ? React__default['default'].createElement(CardImage, {
      src: media.source.url,
      mode: mode,
    ...
    }))), React__default['default'].createElement(MediaDetailsWrapper, {
      mode: mode
    }, React__default['default'].createElement(MemoTitle, {
      title: title,
      theme: theme,
      active: active
    }), React__default['default'].createElement(MemoContentText, {
      content: content
    })));
  };
  ...
  var TimelineItemContent = function (ref) {
    ...
    var slideShowElapsed = React.useRef(0);
    var timerRef = React.useRef(0);
    var startTime = React.useRef();
    var ref$2 = React.useState(false);
    var paused = ref$2[0];
    var setPaused = ref$2[1]; // const [elapsed, setElapsed] = useState(0);

    var ref$3 = React.useState(0);
    var remainInterval = ref$3[0];
    var setRemainInterval = ref$3[1];
    var ref$4 = React.useState(0);
    var startWidth = ref$4[0];
    var setStartWidth = ref$4[1];
    var canShowProgressBar = React.useMemo(function () {
      var canShow = active && slideShowActive;
    ...
    var tryHandlePauseSlideshow = React.useCallback(function () {
      if (active && slideShowActive) {
        window.clearTimeout(timerRef.current);
        setPaused(true);

        if (startTime.current) {
          var elapsed = +new Date() - +startTime.current;
    ...
    }, [active, slideShowActive]); // resumes the slide show

    var tryHandleResumeSlideshow = React.useCallback(function () {
      if (active && slideShowActive) {
        if (!slideItemDuration) {
          return;
        }

        var remainingInterval = slideItemDuration - slideShowElapsed.current; // setRemainInterval(remainingInterval);
    ...
    var handleMediaState = React.useCallback(function (state) {
      if (!slideShowActive) {
        return;
      }
    ...
    return React__default['default'].createElement(TimelineItemContentWrapper, {
      className: active ? 'timeline-card-content active' : 'timeline-card-content ',
      theme: theme,
      noMedia: !media,
      ...
      ref: containerRef
    }, !media && React__default['default'].createElement(MemoTitle, {
      title: title,
      theme: theme
    }), !media && React__default['default'].createElement(MemoContentText, {
      content: content
    }), media && React__default['default'].createElement(CardMedia, {
      media: media,
      content: content,
      title: title,
      mode: mode,
      ...
      hideMedia: showMore,
      cardHeight: cardHeight
    }), React__default['default'].createElement(TimelineContentDetailsWrapper, {
      ref: detailsRef,
      className: !showMore ? 'show-less card-description' : 'card-description',
      theme: theme
    }, detailedText && React__default['default'].createElement(TimelineContentDetails, {
      className: showMore ? 'active' : '',
      ref: detailsRef
    }, detailedText)), React__default['default'].createElement(ShowMore, {
      role: "button",
      onClick: function () {
      ...
      show: canShowMore,
      theme: theme
    }, React__default['default'].createElement("span", null, showMore ? 'read less' : 'read more'), React__default['default'].createElement(ChevronIconWrapper, {
      collapsed: !showMore
    }, React__default['default'].createElement(ChevronRightIcon, null))), canShowProgressBar && React__default['default'].createElement(SlideShowProgressBar, {
...
`;
  ...
  var TimelineItemTitle = function (ref) {
    ...
    return React__default['default'].createElement(TitleWrapper, {
...
`;
  ...
  var TimelineItem = function (ref) {
    ...
    var timelineContent = function () {
      ...
      return React__default['default'].createElement(TimelineContentContainer, {
        className: `${className} timeline-horz-card-wrapper`,
        ref: contentRef
      }, mode === 'VERTICAL' && React__default['default'].createElement(TimelineTitleContainer, {
        "data-testid": "timeline-title",
        className: `${mode.toLowerCase()} ${position}`
      }, React__default['default'].createElement(TimelineItemTitle, {
        title: title,
        active: active,
        theme: theme
      })), React__default['default'].createElement(TimelineItemContent, {
        content: contentText,
        active: active,
        title: contentTitle,
    ...
    var showTimelineContent = function () {
      ...
      if (ele) {
        return ReactDOM__default['default'].createPortal(timelineContent(), ele);
      }
    };
    ...
    }, mode === 'HORIZONTAL' && active ? showTimelineContent() : null, React__default['default'].createElement(TimelinePointWrapper, null, React__default['default'].createElement(TimelinePoint, {
      className: `timeline-circle ${mode.toLowerCase()} ${active ? 'active' : 'in-active'}`,
      onClick: handleClick,
      ref: circleRef,
      "data-testid": "timeline-circle",
      theme: theme
    })), mode === 'HORIZONTAL' && React__default['default'].createElement(TimelineTitleContainer, {
      className: `${mode.toLowerCase()} ${position}`,
      "data-testid": "timeline-title"
    }, React__default['default'].createElement(TimelineItemTitle, {
      title: title,
...
`;
  ...
  var TimelineCollection = function (ref) {
    ...
    return React__default['default'].createElement(TimelineCollectionWrapper, {
      className: `${mode.toLowerCase()} timeline-horz-container`,
      "data-testid": "timeline-collection"
    }, items.map(function (item) { return React__default['default'].createElement(TimelineItemWrapper, {
      key: item.id,
      width: itemWidth,
      className: `${item.visible ? 'visible' : ''} timeline-horz-item-container`
    }, React__default['default'].createElement(TimelineItem, Object.assign({}, item, {
  ...
  var TimelineVerticalWrapper = newStyled.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  width: 100%;
...
`;
  var VerticalItemWrapper = newStyled.div`
  /* align-items: center; */
  display: flex;
  position: relative;
  visibility: hidden;
  width: 100%;
  align-items: stretch;
  /* min-height: ${function (p) { return p.cardHeight; }}px; */
  /* max-height: 1200px; */
  /* height: 0; */
...
`;
  ...
  visibility: hidden;
  ${function (p) { return p.alternateCards ? 'width: 45%;' : 'width: 75%; height: auto;'; }};
  /* padding: 1rem 0; */
...
`;
  ...
  z-index: 1;
`;
  var TimelineTitleWrapper = newStyled.div`
  align-items: center;
  display: flex;
...
`;
  ...
  var VerticalCircle = function (props) {
    ...
    return React__default['default'].createElement(TreeTrunkWrapper, {
      className: className,
      "data-testid": "tree-leaf",
      bg: theme && theme.primary,
      alternateCards: alternateCards,
      role: "button"
    }, React__default['default'].createElement(TrunkPointWrapper, {
      className: className,
      onClick: function () {
    ...
    }, React__default['default'].createElement(TimelinePoint, {
      className: active ? 'active' : 'in-active',
      theme: theme
    })));
  };

  var VerticalItem = function (props) {
    var contentRef = React.useRef(null);
    var active = props.active;
    var alternateCards = props.alternateCards;
    ...
    return React__default['default'].createElement(VerticalItemWrapper, {
      ...
      alternateCards: alternateCards,
      cardHeight: cardHeight
    }, React__default['default'].createElement(TimelineTitleWrapper, {
      className: className,
      alternateCards: alternateCards
    }, React__default['default'].createElement(TimelineItemTitle, {
      title: title,
      active: active,
      theme: theme
    })), React__default['default'].createElement(TimelineCardContentWrapper, {
    ...
    })), React__default['default'].createElement(VerticalCircle, {
      className: className,
      id: id,
      active: active,
      onClick: onClick,
  ...
  var TimelineTree = function (ref) {
    ...
    var handleOnActive = React.useCallback(function (offset, wrapperOffset, height) {
      autoScroll({
    ...
    var handleOnShowMore = React.useCallback(function () {}, []);
    return React__default['default'].createElement(TimelineVerticalWrapper, {
      ...
      return React__default['default'].createElement(VerticalItem, {
        className: className,
        id: item.id,
        index: index,
        onClick: onClick,
...
`;
  ...
  display: flex;
  justify-content: center;
  overflow-y: ${function (p) { return p.scrollable ? 'auto' : 'hidden'; }};
  overscroll-behavior: contain;
  padding: ${function (p) { return p.scrollable ? '1rem 2rem 1rem 0' : '1rem 0'; }};
  position: relative;
...
`;
  ...
  var Timeline = function (props) {
    ...
    var ref = useNewScrollPosition$1(mode, itemWidth);
    var newOffSet = ref[0];
    var setNewOffset = ref[1];
    var observer = React.useRef(null); // reference to the timeline

    var timelineMainRef = React.useRef(null);
    var canScrollTimeline = React.useMemo(function () {
      return scrollable && !slideShowRunning;
    }, [slideShowRunning, scrollable]); // generate a unique id for the timeline content

    var id = React.useRef(nanoid.nanoid()); // handlers for navigation
    ...
    var handleKeySelection = function (event) {
      ...
      if (mode === 'HORIZONTAL' && keyCode === 39 || (mode === 'VERTICAL' || mode === 'VERTICAL_ALTERNATING') && keyCode === 40) {
        handleNext();
      } else if (mode === 'HORIZONTAL' && keyCode === 37 || (mode === 'VERTICAL' || mode === 'VERTICAL_ALTERNATING') && keyCode === 38) {
        handlePrevious();
      } else if (keyCode === 36) {
        handleFirst();
      } else if (keyCode === 35) {
    ...
    var handleScroll = React.useCallback(function (scroll) {
    ...
    React.useEffect(function () {
      ...
      setTimeout(function () {
        ...
        if (element) {
          ...
          Array.from(childElements).forEach(function (elem) {
            if (observer.current) {
      ...
      if (mode !== 'HORIZONTAL') {
        observer.current = new IntersectionObserver(function (entries) {
          ...
          var hide = function (ele) { return ele.style.visibility = 'hidden'; };

          var show = function (ele) { return ele.style.visibility = 'visible'; };
    ...
    return React__default['default'].createElement(Wrapper$1, {
    ...
    }) : null, mode === 'HORIZONTAL' ? React__default['default'].createElement(TimelineMain, {
      className: mode.toLowerCase()
    }, React__default['default'].createElement(Outline, {
      color: theme && theme.primary
    }), React__default['default'].createElement(TimelineCollection, {
      items: items,
      itemWidth: itemWidth,
      ...
      slideItemDuration: slideItemDuration,
      onElapsed: function (id) { return handleTimelineItemClick(id, true); }
    })) : null, mode === 'VERTICAL' ? React__default['default'].createElement(TimelineTree, {
      items: items,
      onClick: handleTimelineItemClick,
      activeTimelineItem: activeTimelineItem,
      autoScroll: handleScroll,
      ...
      slideItemDuration: slideItemDuration,
      onElapsed: function (id) { return handleTimelineItemClick(id, true); }
    }) : null), React__default['default'].createElement(TimelineContentRender, {
      id: id.current
    }), !hideControls && React__default['default'].createElement(TimelineControlContainer$1, {
      mode: mode
    }, React__default['default'].createElement(TimelineControl, {
      onNext: handleNext,
  ...
  var Chrono = function (ref) {
    ...
    var cardHeight = ref.cardHeight; if ( cardHeight === void 0 ) cardHeight = 200;
    var hideControls = ref.hideControls; if ( hideControls === void 0 ) hideControls = false;
    var scrollable = ref.scrollable; if ( scrollable === void 0 ) scrollable = true;

    var ref$1 = React.useState([]);
    var timeLineItems = ref$1[0];
    var setItems = ref$1[1];
    var timeLineItemsRef = React.useRef();
    var ref$2 = React.useState(false);
    ...
    var restartSlideShow = React.useCallback(function () {
    ...
    return React__default['default'].createElement(Timeline, {
      ...
      onTimelineUpdated: React.useCallback(handleTimelineUpdate, []),
      slideItemDuration: slideItemDuration,
